...
void testBinaryResource(const Bundle& bundle)
{
  ...
  std::ifstream png(US_FRAMEWORK_SOURCE_DIR "/test/Integration_Tests/bundles/libRWithResources/resources/icons/cppmicroservices.png",
...
void testCompressedResource(const Bundle& bundle)
{
  ...
  std::ifstream bmp(US_FRAMEWORK_SOURCE_DIR "/test/Integration_Tests/bundles/libRWithResources/resources/icons/compressable.bmp",
                    std::ifstream::in | std::ifstream::binary);
